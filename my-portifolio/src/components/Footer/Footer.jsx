      ...
      <footer>
        <section className="footer-container1">
          <div className="footer-container1-box1">
            ...
            <p className="footer-container1-box1-paragraph">Shoot me email to chat about my work or just like to say hey </p>
          </div>
          <div className="footer-container1-box2">
              ...
              <span className="footer-container1-box2-backToTop">
                <p className="footer-container1-box2-backToTop-paragraph">Back To Top</p>
                <img src={ArrowUp} alt="" className="footer-container1-box2-backToTop-arrowDown" />
               </span>
          </div>
        </section>
        <section className="footer-container2">
          <p className="footer-container2-paragraph">© Coded by Laertes Angelo 💜 </p>
        </section>
      </footer>
    </>
  );
